...
import com.msframe.common.beanvalidator.BeanValidators;
import com.msframe.common.config.Global;
import com.msframe.common.json.AjaxJson;
import com.msframe.common.persistence.Page;
import com.msframe.common.sms.SMSUtils;
import com.msframe.common.utils.DateUtils;
import com.msframe.common.utils.FileUtils;
...
import com.msframe.modules.sys.service.SystemConfigService;
import com.msframe.modules.sys.service.SystemService;
...
public class UserController extends BaseController {
	...
	@RequiresPermissions(value={"sys:user:view"},logical=Logical.OR)
	@RequestMapping(value = "viewDetails")
	public String viewDetails(User user, Model model) {
		if (user.getCompany()==null || user.getCompany().getId()==null){
			user.setCompany(UserUtils.getUser().getCompany());
		}
		if (user.getOffice()==null || user.getOffice().getId()==null){

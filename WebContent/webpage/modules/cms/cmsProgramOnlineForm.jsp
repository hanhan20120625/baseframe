...
<body>
		<form:form id="inputForm" modelAttribute="cmsProgramOnline" action="${ctx}/cms/cmsProgramOnline/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">剧集编号：</label></td>
					<td class="width-35">
						<form:input path="movieId" htmlEscape="false" maxlength="64" class="form-control "/>
					</td>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">是否处理通知：</label></td>
					<td class="width-35">
						<form:select path="dealed" class="form-control ">

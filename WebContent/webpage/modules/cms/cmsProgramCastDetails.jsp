...
<body>
		<form:form id="inputForm" modelAttribute="cmsProgramCast" action="${ctx}/cms/cmsProgramCast/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						${fns:getDictLabel(cmsProgramCast.status, 'general_status', '')}
					</td>
				</tr>
				<tr>

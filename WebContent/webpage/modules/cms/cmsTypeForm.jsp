...
<form:form id="inputForm" modelAttribute="cmsType" action="${ctx}/cms/cmsType/save" method="post"
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-85">
                <sys:treeselect id="category" name="category.id" value="${cmsType.category.id}"
                                labelName="category.name" labelValue="${cmsType.category.name}"
                                title="用户" url="/cms/cmsCategory/treeData?type=3"
                                cssClass="form-control input-sm screen-control required" allowClear="true"

...
<body>
		<form:form id="inputForm" modelAttribute="cmsProgramRegion" action="${ctx}/cms/cmsProgramRegion/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="region" htmlEscape="false" maxlength="64" class="form-control "/>
					</td>
				</tr>
				<tr>

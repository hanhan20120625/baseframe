...
<div class="wrapper wrapper-content">
    <div class="ibox">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <%--@elvariable id="role" type="com.msframe.modules.sys.entity.Role"--%>
                    <form:form id="searchForm" modelAttribute="role" action="${ctx}/sys/role/" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="from-screen-box clearfloat">
                                <span class="screen-title-style">角色名称</span>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <shiro:hasPermission name="sys:role:assign">
                                <a href="#"
                                   onclick="openDialog('权限设置', '${ctx}/sys/role/auth?id=${role.id}','350px', '700px')"

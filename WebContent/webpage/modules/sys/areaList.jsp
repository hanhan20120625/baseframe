    ...
    <tr id="{{row.id}}" pId="{{pid}}">
        ...
        <td>
            ...
            <shiro:hasPermission name="sys:area:edit">
                <a href="javaScript:void(0)" onclick="openDialog('修改区域', '${ctx}/sys/area/form?id={{row.id}}','800px', '500px')"
            ...
            <shiro:hasPermission name="sys:area:add">
                <a href="javaScript:void(0)" onclick="openDialog('添加下级区域', '${ctx}/sys/area/form?parent.id={{row.id}}','800px', '500px')"

...
<body>
<%--@elvariable id="zmsChannelCategory" type="com.msframe.modules.zms.entity.ZmsChannelCategory"--%>
<form:form id="inputForm" modelAttribute="zmsChannelCategory" action="${ctx}/zms/zmsChannelCategory/save" method="post"
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-15 active"><label class="pull-right">类别编号：</label></td>
            <td class="width-35">

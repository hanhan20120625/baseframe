...
<body>
	<form:form id="inputForm" modelAttribute="zmsCategory" action="${ctx}/zms/zmsCategory/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
			...
			<tr>
				...
				<td class="width-35">
					${zmsCategory.parent.name}
				</td>
			</tr>
			<tr>
				<td class="width-15 active"><label class="pull-right">描述：</label></td>
				<td class="width-35">
					${zmsCategory.description}
			...
			<tr>
				...
				<td class="width-35">
					${fns:getDictLabel(zmsCategory.syncState, 'general_sync_state', '')}
			...
			<tr>
				...
				<td class="width-35">
					${fns:getDictLabel(zmsCategory.status, 'general_status', '')}

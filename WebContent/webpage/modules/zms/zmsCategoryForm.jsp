...
<body>
<%--@elvariable id="zmsCategory" type="com.msframe.modules.zms.entity.ZmsCategory"--%>
<form:form id="inputForm" modelAttribute="zmsCategory" action="${ctx}/zms/zmsCategory/save" method="post"
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-35">
                <form:input path="spCategoryid" htmlEscape="false" maxlength="64" class="form-control  "/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="width-35">
                <c:if test="${zmsCategory.icon ne '' and zmsCategory.icon ne null}">
                    <img src="${crc}${zmsCategory.icon}"/>
                </c:if>
                <input type="hidden" name="icon" value="${zmsCategory.icon}"/>
        ...
        <tr>
            ...
            <td class="width-35">
                <c:if test="${zmsCategory.poster ne '' and zmsCategory.poster ne null}">
                    <img src="${crc}${zmsCategory.poster}"/>
                </c:if>
                <input type="hidden" name="poster" value="${zmsCategory.poster}"/>
                <input type="file" name="files" class="form-control"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="width-35">
                <c:if test="${zmsCategory.bgImage ne '' and zmsCategory.bgImage ne null}">
                    <img src="${crc}${zmsCategory.bgImage}"/>
                </c:if>
                <input type="hidden" name="bgImage" value="${zmsCategory.bgImage}"/>
                <input type="file" name="files" class="form-control"/>
            </td>
        </tr>
        <tr>

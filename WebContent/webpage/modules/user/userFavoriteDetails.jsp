...
<body>
		<form:form id="inputForm" modelAttribute="userFavorite" action="${ctx}/user/userFavorite/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
